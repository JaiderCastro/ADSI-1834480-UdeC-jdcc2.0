<?php
 ...
 if (isset($_SESSION['identificacion'])) {
  ...
  try { $conn= new PDO ("mysql:host=$hostt;dbname=$dbname",$user,$password);
    ...
    $sen = $conn->prepare("SELECT * FROM students LIMIT 10"); 
  ...
  <body id="page-top">
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item dropdown no-arrow">
                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  ...
                  <img class="img-profile rounded-circle" src="./img/avatadm.png"> 
                </a>
           ...
           if (isset($_GET['reg'])) {
              $reg = $_GET['reg'];
               ...
               <?php
                   ...
                   <trong>¡Estudiante Creado Con Exito!.
          ...
          <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <a href="crearstudents.php" class="btn btn-primary btn-icon-split">
      ...
      <div class="table-responsive">
        <table class="table table-striped table-sm" id=" tabla"> 
          ...
          <td><?=$row->identificacion?></td>
              ...
              <a class="btn btn-danger btn-circle .btn-sm" href=" delet.php?identificacion=<?=$row->identificacion?>" data-toggle="modal" data-target="#logoutModal<?=$num?>">
                      ...
                      <div class="modal-dialog" role="document">
                          <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                  ...
                                  <a class="btn btn-danger" href="delet.php?identificacion=<?=$row->identificacion?>">Eliminar</a>
                              </div>
                          </div>
                      </div>
                </div>
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">¿Quiere Salir?</h5>
            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">×</span>
            </button>
          </div>
          <div class="modal-body">Seleccione "Salir" si esta list@ Para Abandonar La Seccion.</div>
          <div class="modal-footer">
